...
const Navbar = () => {
    ...
    return (
        <nav className="border-b border-b-brd-light dark:border-b-brd-dark w-full  bg-background flex flex-row justify-between items-center px-14 py-0.5 text-sm">
            <div className="logo">
                <Link
                    href={'/'}
            ...
            <div className="flex flex-row gap-4 justify-around items-center">
                ...
                <div className="cursor-pointer hover:opacity-60 transition duration-300"> Become a Seller </div>
                ...
                {session &&
                    <div className="relative">
                        ...
                        {popupVisible &&
                            <div
                                ref={popupRef}
                                className="popup absolute right-3 top-full flex flex-col items-center justify-center w-80 border border-brd-light dark:border-brd-dark rounded-lg bg-back-light dark:bg-back-dark shadow-light-card dark:shadow-dark-card py-0.5 animate-in slide-in-from-top duration-200"
                            >
                                ...
                                <div className="py-3 mt-4 w-full flex items-center justify-center flex-col">
                                    ...
                                    <div className="image relative py-3 h-20 w-20 rounded-full box-content hover:opacity-80 transition duration-300 cursor-pointer">
                                        <Image
                                            src={session?.user?.image || '/images/defaultProfile.jpg'}
                                            width={200}
                                            height={200}
                                ...
                                <div
                                    ...
                                    <div className="text-center py-2.5 border-y border-brd-light dark:border-brd-dark w-full hover:bg-hvr-light dark:hover:bg-hvr-dark transition duration-300 hover:opacity-60">
                                        My account
                                    </div>

                                    <div className="text-center py-2.5 border-b border-brd-light dark:border-brd-dark w-full hover:bg-hvr-light dark:hover:bg-hvr-dark transition duration-300 hover:opacity-60">
                                        My orders
                                    </div>
